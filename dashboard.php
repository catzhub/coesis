<?php
  ...
  "SELECT election_name, election_year
   FROM elections
   WHERE status='active'
   LIMIT 1"
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Recent Loans <span>| Today</span></h5>
                  ...
                  "SELECT
                   ...
                   ORDER BY ml.member_loan_id DESC
                   LIMIT 5"
