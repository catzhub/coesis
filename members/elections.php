...
Swal.fire({
  ...
  text: "Winners successfully declared."
...
?>
                    ...
                    <td width="1%" style="white-space:nowrap" class="text-end">
                      <?php if ($row['status'] == 'Open') { ?>
                        ...
                        <button
                          ...
                          onclick="confirmCloseElection(<?= $row['election_id'] ?>)">
                      ...
                      <?php } ?>
                      <a href="election_results.php?id=<?= $row['election_id'] ?>"
  ...
  <script>
    ...
    function confirmCloseElection(id){
  ...
  Swal.fire({
    ...
    text:
    "This will stop voting and allow winners to be finalized.",
